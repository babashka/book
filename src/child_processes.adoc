...
remaining 10% you're going to need something slightly more powerful.
...
* https://github.com/lambdaisland/open-source/blob/1034bb607f5535c3089437069abbbfbe82cc4cec/src/lioss/subshell.clj#L10[lambdaisland/open-source]

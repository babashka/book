...
If you want a lower level to control babashka's classpath, without the usage of
`bb.edn` you can use the `--classpath` option that will override the classpath.
Say we have a file `script/my/namespace.clj`:

...
[source,bash]
----
$ bb socket-repl 1666 --classpath src:test
----
...
Since babashka 0.3.1 supports a local `bb.edn` file where you can declare one
...
function `foo.bar/-main` will be executed while it receives command line

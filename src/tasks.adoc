...
# uncomment only one of the following lines that start with 'complete'
complete -f -F _bb_tasks bb # autocomplete both filenames and tasks
# complete -F _bb_tasks bb # autocomplete only tasks
----
